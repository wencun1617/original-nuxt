...
//#region useMediaQuery
// Reactive Media Query. Once you've created a MediaQueryList object,
// you can check the result of the query or receive notifications when the result changes.
//#endregion

//#region useParallax
// Create parallax effect easily. 
// It uses useDeviceOrientation and fallback to useMouse if orientation is not supported.
//#endregion
